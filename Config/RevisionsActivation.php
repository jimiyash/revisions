 ...
 */
	public function onActivation(&$controller) {
		...
		$sql = file_get_contents(APP.'Plugin'.DS.'Revisions'.DS.'Config'.DS.'revisions.sql');
 ...
 */
	public function onDeactivation(&$controller) {
		...
		// Attempt to add a revisions table to the database
		$sql = file_get_contents(APP.'Plugin'.DS.'Revisions'.DS.'Config'.DS.'revisions_deactivate.sql');
		if(!empty($sql)){
			$db = ConnectionManager::getDataSource('default');
